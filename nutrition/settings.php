...
$uprf=mysql_query("select * from `nutri_reg`  where reg_id='$user_id'") or die(mysql_error());
...
if(isset($_POST['login']))
{
  ...
  $password=$_POST['pwd'];
$logqry=mysql_query("update `nutri_reg` set Username='$username' ,  Password='$password' where reg_id='$user_id'") or die(mysql_error());
