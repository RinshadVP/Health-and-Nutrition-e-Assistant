...
$uprf=mysql_query("select * from `user_reg`  where Reg_id='$user_id'") or die(mysql_error());
...
if(isset($_POST['login']))
{
  ...
  $password=$_POST['pwd'];
$logqry=mysql_query("update `user_reg` set  password='$password' where Reg_id='$user_id'") or die(mysql_error());
...
<div class="container">
  <div class="row">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" readonly="" class="form-control" id="username" placeholder="Enter username" name="username" value="<?php  echo $datas['name']  ?>">
      </div>
    </div>
    <div class="form-group">
